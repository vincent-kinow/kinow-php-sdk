...
class GendersApi
{
     ...
     * @return \Kaemo\Client\Model\Genders
     */
    public function getGenders($page = null, $per_page = null)
    {
        list($response) = $this->getGendersWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     * @param int $per_page  (optional)
     * @throws \Kaemo\Client\ApiException on non-2xx response
     * @return array of \Kaemo\Client\Model\Genders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGendersWithHttpInfo($page = null, $per_page = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Kaemo\Client\Model\Genders',
                '/genders'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Kaemo\Client\Model\Genders', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Kaemo\Client\Model\Genders', $e->getResponseHeaders());
