...
class CartsApi
{
     ...
     * 
     *
     * @param \Swagger\Client\Model\CartBody $body Create cart object (required)
     * @return \Swagger\Client\Model\Cart
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @return \Swagger\Client\Model\Carts
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $sort_by Sort by this attribute (id by default) (optional)
     * @param string $sort_direction Sorting direction (asc by default) (optional)
     * @return Array of \Swagger\Client\Model\Carts, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCustomerCartsWithHttpInfo($customer_id, $page = null, $per_page = null, $filters = null, $sort_by = null, $sort_direction = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\Carts',
                '/customers/{customer_id}/carts'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Carts', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Carts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param \Swagger\Client\Model\Cart $body Cart body (required)
     * @return \Swagger\Client\Model\Cart
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
