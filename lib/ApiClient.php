...
class ApiClient
{
     ...
     */
    public function __construct(\Kaemo\Client\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Kaemo\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Kaemo\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
        ...
        if (isset($this->config->getProxy()['host'])) {
            $proxy = $this->config->getProxy();
            curl_setopt($curl, CURLOPT_PROXY, $proxy['host']);
            curl_setopt($curl, CURLOPT_PROXYUSERPWD, $proxy['userpass']);
            curl_setopt($curl, CURLOPT_PROXYTYPE, $proxy['proxytype']);
        }
