...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
        ...
        } elseif (in_array($class, ['integer', 'int', 'void', 'number', 'object', 'double', 'float', 'byte', 'DateTime', 'string', 'mixed', 'boolean', 'bool'], true)) {
            settype($data, $class);
            return $data;
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Kaemo\Client\Model\\' . $data->{$discriminator};
