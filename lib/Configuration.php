...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://api.dev.km/api';
    ...
    /**
     * Set an http proxy for curl
     *
     * @param array $proxy the proxy configuration
     *
     * @return Configuration
     */
    ...
    {
        $report  = 'PHP SDK (Kaemo\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.0.152' . PHP_EOL;
